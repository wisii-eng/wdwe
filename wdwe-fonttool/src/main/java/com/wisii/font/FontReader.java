...
public class FontReader extends DefaultHandler {
    ...
    private void createFont(InputSource source) throws Exception {
        ...
        try {
            ...
            throw new Exception("You need a SAX parser which supports SAX version 2",
                                   e);
        }
     ...
     */
    public FontReader(InputSource source) throws Exception {
        createFont(source);
    }
