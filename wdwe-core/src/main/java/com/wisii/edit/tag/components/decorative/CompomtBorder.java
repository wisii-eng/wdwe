...
public class CompomtBorder extends AbstractBorder
{
	 ...
	 * @param borderImg
	 */
	public CompomtBorder(Image[] borderImg)
	{
	 ...
	 * @param borderImgIcon
	 */
	public CompomtBorder(ImageIcon[] borderImgIcon)
	{
	...
	public Insets getBorderInsets(Component c)
	{
		...
		{
			return new Insets(0, this.borderImg[0].getWidth(null),
					this.borderImg[2].getHeight(null), this.borderImg[4]
							.getWidth(null));
		}
	}
	...
	public void paintBorder(Component c, Graphics g, int x, int y, int w, int h)
	{
		...
		int bottomheight = this.borderImg[2].getHeight(null);
		int leftwidth = this.borderImg[0].getWidth(null);
		int rightwidth = this.borderImg[4].getWidth(null);
		int height = c.getHeight();
		int width = c.getWidth();
		this.fillTexture(g2d, this.borderImg[0], x, y, leftwidth, height
				- bottomheight);
		this.fillTexture(g2d, this.borderImg[1], x, y + height - bottomheight,
				leftwidth, bottomheight);
		this.fillTexture(g2d, this.borderImg[2], x + leftwidth, y + height
				- bottomheight, width - leftwidth - rightwidth, bottomheight);
		this.fillTexture(g2d, this.borderImg[3], x + width - rightwidth, y
				+ height - bottomheight, rightwidth, bottomheight);
