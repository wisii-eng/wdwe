 ...
 *//* $Id: BlockStackingLayoutManager.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
import com.wisii.fov.area.BlockParent;
...
import com.wisii.fov.layoutmgr.inline.LineLayoutManager;
...
/*LF*/  //log.debug("  BLM.getChangedKnuthElements> inizio: oldList.size() = "
        ...
        if (fobj instanceof com.wisii.fov.fo.flow.Block) {
            spaceBeforeIsConditional = ((com.wisii.fov.fo.flow.Block)fobj)
...
/* estensione */
        ...
        if (fobj instanceof com.wisii.fov.fo.flow.Block) {
            spaceAfterIsConditional = ((com.wisii.fov.fo.flow.Block)fobj)
    ...
    private CommonBorderPaddingBackground getBorderPaddingBackground() {
        if (fobj instanceof com.wisii.fov.fo.flow.Block) {
            return ((com.wisii.fov.fo.flow.Block)fobj)
                .getCommonBorderPaddingBackground();
        } else if (fobj instanceof com.wisii.fov.fo.flow.BlockContainer) {
            return ((com.wisii.fov.fo.flow.BlockContainer)fobj)
                .getCommonBorderPaddingBackground();
        } else if (fobj instanceof com.wisii.fov.fo.flow.ListBlock) {
            return ((com.wisii.fov.fo.flow.ListBlock)fobj)
                .getCommonBorderPaddingBackground();
        } else if (fobj instanceof com.wisii.fov.fo.flow.ListItem) {
            return ((com.wisii.fov.fo.flow.ListItem)fobj)
                .getCommonBorderPaddingBackground();
        } else if (fobj instanceof com.wisii.fov.fo.flow.Table) {
            return ((com.wisii.fov.fo.flow.Table)fobj)
                .getCommonBorderPaddingBackground();
        } else {
            return null;
        }
    ...
    protected boolean addKnuthElementsForBreakBefore(LinkedList returnList,
        ...
        int breakBefore = -1;
        if (fobj instanceof com.wisii.fov.fo.flow.Block) {
            breakBefore = ((com.wisii.fov.fo.flow.Block) fobj).getBreakBefore();
        } else if (fobj instanceof com.wisii.fov.fo.flow.BlockContainer) {
            breakBefore = ((com.wisii.fov.fo.flow.BlockContainer) fobj).getBreakBefore();
        } else if (fobj instanceof com.wisii.fov.fo.flow.ListBlock) {
            breakBefore = ((com.wisii.fov.fo.flow.ListBlock) fobj).getBreakBefore();
        } else if (fobj instanceof com.wisii.fov.fo.flow.ListItem) {
            breakBefore = ((com.wisii.fov.fo.flow.ListItem) fobj).getBreakBefore();
        } else if (fobj instanceof com.wisii.fov.fo.flow.Table) {
            breakBefore = ((com.wisii.fov.fo.flow.Table) fobj).getBreakBefore();
        }
    ...
    protected boolean addKnuthElementsForBreakAfter(LinkedList returnList,
        ...
        int breakAfter = -1;
        if (fobj instanceof com.wisii.fov.fo.flow.Block) {
            breakAfter = ((com.wisii.fov.fo.flow.Block) fobj).getBreakAfter();
        } else if (fobj instanceof com.wisii.fov.fo.flow.BlockContainer) {
            breakAfter = ((com.wisii.fov.fo.flow.BlockContainer) fobj).getBreakAfter();
        } else if (fobj instanceof com.wisii.fov.fo.flow.ListBlock) {
            breakAfter = ((com.wisii.fov.fo.flow.ListBlock) fobj).getBreakAfter();
        } else if (fobj instanceof com.wisii.fov.fo.flow.ListItem) {
            breakAfter = ((com.wisii.fov.fo.flow.ListItem) fobj).getBreakAfter();
        } else if (fobj instanceof com.wisii.fov.fo.flow.Table) {
            breakAfter = ((com.wisii.fov.fo.flow.Table) fobj).getBreakAfter();
        }
...
//                        (!spaceAfter.getSpace().isDiscard()) ? false : true));
    ...
    protected LinkedList createUnitElements(LinkedList oldList) {
        ...
        if (fobj instanceof com.wisii.fov.fo.flow.Block) {
            correctFirstElement = ((com.wisii.fov.fo.flow.Block)fobj)
                .getCommonMarginBlock().spaceBefore.getSpace().isDiscard();
        }
        ...
        if (fobj instanceof com.wisii.fov.fo.flow.Block) {
            correctLastElement = ((com.wisii.fov.fo.flow.Block)fobj)
                    .getCommonMarginBlock().spaceAfter.getSpace().isDiscard();
        }
