...
public class BlockLayoutManager extends BlockStackingLayoutManager
     ...
     */
    public BlockLayoutManager(com.wisii.fov.fo.flow.Block inBlock) {
        super(inBlock);
    ...
    /**
     * @see com.wisii.fov.layoutmgr.LayoutManager#addAreas(com.wisii.fov.layoutmgr.PositionIterator, com.wisii.fov.layoutmgr.LayoutContext)
     */
    ...
    public Area getParentArea(Area childArea) {
        if (curBlockArea == null) {
            ...
            /* 【添加：START】by 李晓光	2009-10-22 */
            curBlockArea.setSource(getBlockFO());
            /* 【添加：END】by 李晓光	2009-10-22 */
        }
        return curBlockArea;
    }
     ...
     */
    protected com.wisii.fov.fo.flow.Block getBlockFO() {
