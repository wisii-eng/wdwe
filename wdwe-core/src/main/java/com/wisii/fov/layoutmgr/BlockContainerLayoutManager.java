...
public class BlockContainerLayoutManager extends BlockStackingLayoutManager
    ...
    */
    ...
    /** @see com.wisii.fov.layoutmgr.LayoutManager#getContentAreaBPD() */
            ...
            if (abProps.bottom.getEnum() != EN_AUTO) {
                ...
                if (abProps.bottom.getEnum() != EN_AUTO) {
                    ...
                    if (allocBPD < 0) {
                         ...
                         * See: http://marc.theaimsgroup.com/?l=fov-dev&m=113189981926163&w=2
    ...
    private class BlockContainerBreaker extends AbstractBreaker {
        ...
        /** @see com.wisii.fov.layoutmgr.AbstractBreaker#observeElementList(java.util.List) */
        protected void observeElementList(List elementList) {
            ElementListObserver.observe(elementList, "block-container",
                    bclm.getBlockContainerFO().getId());
        }

        /** @see com.wisii.fov.layoutmgr.AbstractBreaker#isPartOverflowRecoveryActivated() */
        protected boolean isPartOverflowRecoveryActivated() {
            //For block-containers, this must be disabled because of wanted overflow.
            return false;
        }

        /** @see com.wisii.fov.layoutmgr.AbstractBreaker#isSinglePartFavored() */
    ...
    public void addAreas(PositionIterator parentIter,
        ...
        while (parentIter.hasNext()) {
            ...
            if (pos instanceof BlockContainerPosition) {
                if (bcpos != null) {
                    throw new IllegalStateException("只允许有一个BlockContainerPosition");
                }
     ...
     *
     * @see com.wisii.fov.layoutmgr.LayoutManager#getParentArea(Area)
     */
    public Area getParentArea(Area childArea) {
        if (referenceArea == null) {
            ...
            viewportBlockArea.setSource(getBlockContainerFO());
    ...
    /**
     * @see com.wisii.fov.layoutmgr.LayoutManager#resetPosition(com.wisii.fov.layoutmgr.Position)
     */
