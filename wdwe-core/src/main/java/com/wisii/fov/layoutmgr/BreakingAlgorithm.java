 ...
 *//* $Id: BreakingAlgorithm.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
public abstract class BreakingAlgorithm {
    ...
    public int findBreakingPoints(KnuthSequence par, int startIndex,
        ...
        if (alignment != com.wisii.fov.fo.Constants.EN_CENTER) {
    ...
    protected int getLineWidth(int line) {
        if (this.lineWidth < 0) {
            throw new IllegalStateException("线宽必须设置"
