 ...
 *//* $Id: BreakElement.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
public class BreakElement extends UnresolvedListElement {
    ...
    /** @see com.wisii.fov.layoutmgr.UnresolvedListElement#isConditional() */
    public boolean isConditional() {
        return false; //Does not really apply here
    }

    /** @see com.wisii.fov.layoutmgr.ListElement#isPenalty() */
    /*
    ...
    /** @see com.wisii.fov.layoutmgr.ListElement#isForcedBreak() */
