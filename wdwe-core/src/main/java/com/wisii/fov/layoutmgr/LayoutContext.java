 ...
 *//* $Id: LayoutContext.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
import com.wisii.fov.layoutmgr.inline.HyphContext;
...
public class LayoutContext {
    ...
    public void signalSpanChange(int span) {
        if (span == Constants.NOT_SET || span == Constants.EN_NONE || span == Constants.EN_ALL) {
            ...
            throw new IllegalArgumentException("signalSpanChange()范围: "
                    + span  + "值不合法");
        }
    }
