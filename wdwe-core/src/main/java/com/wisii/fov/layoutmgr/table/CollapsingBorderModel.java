 ...
 *//* $Id: CollapsingBorderModel.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
import com.wisii.fov.fo.properties.CommonBorderPaddingBackground.BorderInfo;
...
public abstract class CollapsingBorderModel {
    ...
    public static CollapsingBorderModel getBorderModelFor(int borderCollapse) {
        switch (borderCollapse) {
            ...
            default:
                throw new IllegalArgumentException("非法的 border-collapse模型.");
        }
    }
    ...
    public static int getOtherSide(int side) {
        switch (side) {
            ...
            default:
                throw new IllegalArgumentException("非法对数: side");
        }
    }
    ...
    public int getPreferenceValue(int style) {
        switch (style) {
            ...
            default: throw new IllegalStateException("非法的边界设计: " + style);
        }
    }
