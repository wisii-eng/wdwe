 ...
 *//* $Id: TableStepper.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
import com.wisii.fov.layoutmgr.table.TableContentLayoutManager.GridUnitPart;
import com.wisii.fov.layoutmgr.table.TableContentLayoutManager.TableContentPosition;
import com.wisii.fov.layoutmgr.table.TableContentLayoutManager.TableHFPenaltyPosition;
            ...
            if (isBreakCondition()) {
                if (skippedStep) {
                    log.error("This is a conflict situation. The output may be wrong."
                            + " Please send your FO file to tech@wisii.com!");
                }
