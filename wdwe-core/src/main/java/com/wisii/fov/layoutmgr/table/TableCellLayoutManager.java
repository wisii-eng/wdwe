 ...
 *//* $Id: TableCellLayoutManager.java,v 1.2 2007/08/22 09:22:29 hzl Exp $ */
...
import com.wisii.fov.layoutmgr.AreaAdditionUtil;
...
public class TableCellLayoutManager extends BlockStackingLayoutManager
    ...
    /** @see com.wisii.fov.layoutmgr.BlockStackingLayoutManager#getIPIndents() */
    ...
    public Area getParentArea(Area childArea) {
        if (curBlockArea == null) {
            ...
            curBlockArea.addTrait(Trait.TABLE_CELL, Boolean.TRUE);
