...
import com.wisii.fov.layoutmgr.inline.KnuthInlineBox;
...
public class InlineKnuthSequence extends KnuthSequence  {
    ...
    /* (non-Javadoc)
     * @see com.wisii.fov.layoutmgr.KnuthSequence#canAppendSequence(com.wisii.fov.layoutmgr.KnuthSequence)
     */
    ...
    /* (non-Javadoc)
     * @see com.wisii.fov.layoutmgr.KnuthSequence#appendSequence(com.wisii.fov.layoutmgr.KnuthSequence)
     */
