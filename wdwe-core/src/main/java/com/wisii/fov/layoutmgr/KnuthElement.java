 ...
 *//* $Id: KnuthElement.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
public abstract class KnuthElement extends ListElement {
    ...
    public int getP() {
        throw new RuntimeException("元素不是一个 penalty");
    }

    /** @return the stretch value of this element, if applicable. */
    public int getY() {
        throw new RuntimeException("元素不是一个glue");
    }
    ...
    /** @see com.wisii.fov.layoutmgr.ListElement#isUnresolvedElement() */
