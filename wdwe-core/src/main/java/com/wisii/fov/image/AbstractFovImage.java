...
public abstract class AbstractFovImage implements FovImage, Serializable {
     ...
     * logging instance
     */
    protected static Log log = LogFactory.getLog(AbstractFovImage.class);
    ...
    /**
     * Constructor.
     * Construct a new FovImage object and initialize its default properties:
     * <UL>
     * <LI>image width
     * <LI>image height
     * </UL>
    ...
    /** @see com.wisii.fov.image.FovImage#getOriginalURI() */
    ...
    /** @see com.wisii.fov.image.FovImage#getIntrinsicWidth() */
    public int getIntrinsicWidth() {
        return (int)(getWidth() * 72000 / getHorizontalResolution());
    }

    /** @see com.wisii.fov.image.FovImage#getIntrinsicHeight() */
    public int getIntrinsicHeight() {
        return (int)(getHeight() * 72000 / getVerticalResolution());
    }

    /** @see com.wisii.fov.image.FovImage#getHorizontalResolution() */
    public double getHorizontalResolution() {
        return this.dpiHorizontal;
    }

    /** @see com.wisii.fov.image.FovImage#getVerticalResolution() */
