 ...
 *//* $Id: ImageIOImage.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
/**
 * FovImage object using ImageIO.
 * @see AbstractFovImage
 * @see FovImage
 */
public class ImageIOImage extends AbstractFovImage {

    /**
     * Creates a new ImageIOImage.
     * @param info the image info from the ImageReader
     */
    public ImageIOImage(FovImage.ImageInfo info) {
        super(info);
    ...
    /** @see com.wisii.fov.image.AbstractFovImage#loadOriginalData() */
