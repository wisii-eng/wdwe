 ...
 *//* $Id: XmlGraphicsCommonsImage.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
/**
 * Abstract FovImage implementation which uses the internal codecs from XML Graphics Commons.
 * @see AbstractFovImage
 * @see FovImage
 */
public abstract class XmlGraphicsCommonsImage extends AbstractFovImage {
     ...
     */
    public XmlGraphicsCommonsImage(FovImage.ImageInfo imgReader) {
        super(imgReader);
    }

    /**
     * @see com.wisii.fov.image.AbstractFovImage#loadDimensions()
     */
    ...
    /**
     * @see com.wisii.fov.image.AbstractFovImage#loadBitmap()
     */
    ...
    /**
     * @see com.wisii.fov.image.FovImage#hasSoftMask()
     */
    ...
    /**
     * @see com.wisii.fov.image.FovImage#getSoftMask()
     */
