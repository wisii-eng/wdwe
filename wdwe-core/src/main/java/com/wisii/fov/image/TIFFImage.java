 ...
 *//* $Id: TIFFImage.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
public class TIFFImage extends XmlGraphicsCommonsImage {
     ...
     */
    public TIFFImage(FovImage.ImageInfo imgReader) {
        super(imgReader);
    }
    ...
    /**
     * @see com.wisii.fov.image.XmlGraphicsCommonsImage#decodeImage(
