 ...
 *//* $Id: SVGReader.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
public class SVGReader implements ImageReader {
     ...
     */
    private FovImage.ImageInfo loadImage(String uri, InputStream bis,
            FOUserAgent ua) {
        if (batik) {
            try {
     ...
     */
    class Loader {
        private FovImage.ImageInfo getImage(String uri, InputStream fis,
                float pixelUnitToMM) {
