 ...
 *//* $Id: GifImage.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
/**
 * FovImage object for GIF images, using Java native classes.
 * @author Eric SCHAEFFER
 * @author Modified by Eric Dalquist - 9/14/2001 - ebdalqui@mtu.edu
 * @see AbstractFovImage
 * @see FovImage
 */
public class GifImage extends AbstractFovImage {
     ...
     */
    public GifImage(FovImage.ImageInfo imgInfo) {
        super(imgInfo);
    }
    ...
    protected boolean loadBitmap() {
        ...
        try {
            ...
            FovImageConsumer consumer = new FovImageConsumer(ip);
