 ...
 *//* $Id: JpegImage.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
import com.wisii.fov.util.CMYKColorSpace;

/**
 * FovImage object for JPEG images, Using Java native classes.
 * @author Eric Dalquist
 * @see AbstractFovImage
 * @see FovImage
 */
public class JpegImage extends AbstractFovImage {
     ...
     */
    public JpegImage(FovImage.ImageInfo imgInfo) {
        super(imgInfo);
    }
