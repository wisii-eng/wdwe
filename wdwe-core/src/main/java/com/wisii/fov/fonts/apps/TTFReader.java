 ...
 *//* $Id: TTFReader.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
import com.wisii.fov.fonts.truetype.TTFCmapEntry;
import com.wisii.fov.fonts.truetype.TTFFile;
...
public class TTFReader extends AbstractFontReader {
     ...
     * -er <path to truetype fontfile relative to org/apache/fov/render/pdf/fonts>
    ...
    public static void main(String[] args) {
        ...
        log.info("TTF Reader for Apache FOV " + Version.getVersion() + "\n");
