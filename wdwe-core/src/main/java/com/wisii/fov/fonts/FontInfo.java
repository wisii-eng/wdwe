 ...
 *//* $Id: FontInfo.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
public class FontInfo {
    ...
    public void addFontPropertieMaps(Map t) {
        /*
         * add the given family, style and weight as a lookup for the font
         * with the given name
         */
        this.triplets.putAll(t);
    }
    public void addMetricMaps(Map f) {
        // add the given metrics as a font with the given name
    ...
    private FontTriplet fontLookup(String family, String style,
        ...
        if (f == null) {
            ...
            if (f == null) {
                ...
                key = createFontKey("宋体", style, weight);
                f = getInternalFontKey(key);
            }
    ...
    public FontTriplet fontLookup(String[] family, String style,
        ...
        throw new IllegalStateException("在最后一次字体查找必须返回一个key");
    }
