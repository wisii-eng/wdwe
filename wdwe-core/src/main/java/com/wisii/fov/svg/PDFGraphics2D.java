...
/* $Id: PDFGraphics2D.java 426576 2006-07-28 15:44:37Z jeremias $ */
...
import com.wisii.fov.pdf.PDFGState;
...
import com.wisii.fov.pdf.PDFPattern;
...
import com.wisii.fov.fonts.LazyFont;
import com.wisii.fov.image.JpegImage;
import com.wisii.fov.fonts.CIDFont;
 ...
 * @version $Id: PDFGraphics2D.java 426576 2006-07-28 15:44:37Z jeremias $
...
public class PDFGraphics2D extends AbstractGraphics2D {
    ...
    public void addJpegImage(JpegImage jpeg, float x, float y,
        ...
        jpegCount[0]++;
        FovPDFImage fovimage = new FovPDFImage(jpeg, key);
    ...
    public boolean drawImage(Image img, int x, int y, int width, int height,
        ...
        // otherwise we have to build a FovImage and add it to the pdf
        // document
        ...
        if (imageInfo == null) {
            ...
            if (hasMask) {
                ...
                BitmapImage fovimg = new BitmapImage("TempImageMask:"
                ...
                PDFXObject xobj = pdfDoc.addImage(resourceContext, fovimg);
            ...
            BitmapImage fovimg = new BitmapImage("TempImage:"
                                          + img.toString(), buf.getWidth(),
                                          buf.getHeight(), result, ref);
            imageInfo = pdfDoc.addImage(resourceContext, fovimg);
...
*/
    ...
    protected boolean applyUnknownPaint(Paint paint, Shape shape) {
        ...
        if (imageInfo != null) {
            ...
            BitmapImage fovimg;
            fovimg = new BitmapImage("TempImage:" + pctx.toString(),
                                     devW, devH, rgb, maskRef);
            fovimg.setTransparent(new PDFColor(255, 255, 255));
            imageInfo = pdfDoc.addImage(resourceContext, fovimg);
            if (outputStream != null) {
                try {
                    this.pdfDoc.output(outputStream);
    ...
    public void drawString(String s, float x, float y) {
        ...
        com.wisii.fov.fonts.Typeface f =
            (com.wisii.fov.fonts.Typeface)fontInfo.getFonts().get(name);
