 ...
 *//* $Id: AbstractFOVTranscoder.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
/**
 * This is the common base class of all of FOV's transcoders.
 */
public abstract class AbstractFOVTranscoder extends SVGAbstractTranscoder
            {
    ...
    /**
     * Constructs a new FOV-style transcoder.
     */
    public AbstractFOVTranscoder() {
    ...
    protected UserAgent createUserAgent() {
        return new FOVTranscoderUserAgent();
    }
    ...
    protected final Log getLogger() {
        if (this.logger == null) {
            this.logger = new SimpleLog("FOV/Transcoder");
    ...
    protected DocumentFactory createDocumentFactory(DOMImplementation domImpl,
        ...
        final FOVSAXSVGDocumentFactory factory
                = new FOVSAXSVGDocumentFactory(parserClassname);
    ...
    // --------------------------------------------------------------------
    // FOV's default error handler (for transcoders)
    // --------------------------------------------------------------------

    /**
     * This is the default transcoder error handler for FOV. It logs error
     * to an Commons Logger instead of to System.out. The remaining behaviour
     * is the same as Batik's DefaultErrorHandler.
     */
    protected class FOVErrorHandler implements ErrorHandler {
    ...
    /**
     * A user agent implementation for FOV's Transcoders.
     */
    protected class FOVTranscoderUserAgent extends SVGAbstractTranscoderUserAgent {
