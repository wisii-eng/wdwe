...
/* $Id: CharacterSet.java 426576 2006-07-28 15:44:37Z jeremias $ */
...
import com.wisii.fov.render.afp.tools.StringUtils;
...
public class CharacterSet {
    ...
    /**
     * The current orientation (currently only 0 is suppoted by FOV)
     */
     ...
     * that FOV does not yet implement the "reference-orientation"
     ...
     * implementation (whenever FOV implement the mechanism). This is also
