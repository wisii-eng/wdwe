...
/* $Id: AFPFontReader.java 426576 2006-07-28 15:44:37Z jeremias $ */
...
import com.wisii.fov.render.afp.tools.StructuredFieldReader;
...
public final class AFPFontReader {
     ...
     */
    private static final int FOV_100_DPI_FACTOR = 1;

    /**
     * The conversion factor to millipoints for 240 dpi
     */
    private static final int FOV_240_DPI_FACTOR = 300000;

    /**
     * The conversion factor to millipoints for 300 dpi
     */
    private static final int FOV_300_DPI_FACTOR = 240000;
    ...
    private static void processFontPosition(StructuredFieldReader sfr,
        ...
        switch (dpi) {
            case 100:
                fovFactor = FOV_100_DPI_FACTOR;
                break;
            case 240:
                fovFactor = FOV_240_DPI_FACTOR;
                break;
            case 300:
                fovFactor = FOV_300_DPI_FACTOR;
                break;
            default:
        ...
        for (int index = 3; index < data.length; index++) {
            if (position < 22) {
                ...
                cso.setXHeight(xHeight * fovFactor);
                cso.setCapHeight(capHeight * fovFactor);
                cso.setAscender(ascHeight * fovFactor);
                cso.setDescender(dscHeight * fovFactor);
