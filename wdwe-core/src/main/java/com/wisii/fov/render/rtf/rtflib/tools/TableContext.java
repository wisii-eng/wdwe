...
/* $Id: TableContext.java 426576 2006-07-28 15:44:37Z jeremias $ */

package com.wisii.fov.render.rtf.rtflib.tools;

import java.util.List;

import org.apache.commons.logging.impl.SimpleLog;
import org.apache.commons.logging.Log;
import com.wisii.fov.render.rtf.rtflib.rtfdoc.ITableColumnsInfo;
 ...
 *  is now integrated into FOV.
 */

public class TableContext implements ITableColumnsInfo {
    private final Log log = new SimpleLog("FOV/RTF");
     ...
     * The 'public' modifier has been added by Boris Poud茅rous for
