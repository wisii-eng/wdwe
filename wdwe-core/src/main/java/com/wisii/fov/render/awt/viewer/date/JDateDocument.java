...
public class JDateDocument extends PlainDocument{
    ...
    public void insertString(int offset, String s,
        ...
        if(s.length() == 1){
            ...
            // mod by huangzl.因为目前只支持日期的输入，所以只处理4、7位置的情况
//            if(offset == 4 || offset == 7 ||
//               offset == 10 || offset == 13 ||
//               offset == 16){
            if(offset == 4 || offset == 7){ // mod end.
                newOffset++;
        ...
        JDatePicker picker = (JDatePicker) textComponent.getParent();
        picker.setSelectedItem(textComponent.getText());
    }
