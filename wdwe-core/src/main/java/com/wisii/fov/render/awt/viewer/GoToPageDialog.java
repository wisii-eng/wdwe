 ...
 *//* $Id: GoToPageDialog.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
public class GoToPageDialog extends JDialog {
     ...
     */
    public GoToPageDialog(String title) {
    ...
    private void jbInit() {
		...
		//set the default button associated to the Enter
		getRootPane().setDefaultButton(okButton);//add by huangzl
    }
