 ...
 *//* $Id: Java2DFontMetrics.java,v 1.5.2.1 2007/09/30 03:09:16 lzy Exp $ */
...
//    	如果取不到自定义的字体,则用本机字体.
    	if(f==null){
    		...
    		return f.deriveFont(style,size); //得到相应的样式和大小的同种字体.
    	}
     ...
     * of FOV-defined fonts to java-fonts can be done
