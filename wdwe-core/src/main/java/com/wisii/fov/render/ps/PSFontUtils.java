...
/* $Id: PSFontUtils.java 426576 2006-07-28 15:44:37Z jeremias $ */
...
public class PSFontUtils extends org.apache.xmlgraphics.ps.PSFontUtils {
    ...
    public static Map writeFontDict(PSGenerator gen, FontInfo fontInfo) 
                throws IOException {
        gen.commentln("%FOVBeginFontDict");
        gen.writeln("/FOVFonts 100 dict dup begin");
        ...
        while (iter.hasNext()) {
            ...
            gen.commentln("%FOVBeginFontKey: " + key);
            gen.writeln("/" + key + " /" + tf.getFontName() + " def");
            gen.commentln("%FOVEndFontKey");
        }
        gen.writeln("end def");
        gen.commentln("%FOVEndFontDict");
        gen.commentln("%FOVBeginFontReencode");
        ...
        gen.commentln("%FOVEndFontReencode");
