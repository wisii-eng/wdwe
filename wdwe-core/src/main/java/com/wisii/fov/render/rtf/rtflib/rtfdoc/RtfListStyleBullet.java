...
/* $Id: RtfListStyleBullet.java 426576 2006-07-28 15:44:37Z jeremias $ */
...
public class RtfListStyleBullet extends RtfListStyle {
     ...
     * @see com.wisii.fov.render.rtf.rtflib.rtfdoc.RtfListStyle#writeListPrefix(RtfListItem)
     ...
     * @see com.wisii.fov.render.rtf.rtflib.rtfdoc.RtfListStyle#writeParagraphPrefix(RtfElement)
     * @throws IOException Thrown when an IO-problem occurs
     */
     ...
     * 
     * @param element RtfElement in whose context is to be written
     * @see com.wisii.fov.render.rtf.rtflib.rtfdoc.RtfListStyle#writeLevelGroup(RtfElement)
     * @throws IOException Thrown when an IO-problem occurs
     */
