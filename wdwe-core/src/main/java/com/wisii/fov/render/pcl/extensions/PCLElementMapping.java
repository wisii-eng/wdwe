...
package com.wisii.fov.render.pcl.extensions;
...
/**
 * PCL-specific extensions for Apache FOV.
 */
public class PCLElementMapping extends ElementMapping {

    /** The namespace used for PCL extensions */
    public static final String NAMESPACE = "http://xmlgraphics.apache.org/fov/extensions/pcl";
