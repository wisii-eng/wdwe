...
/* $Id: CTMHelper.java 426576 2006-07-28 15:44:37Z jeremias $ */
...
/**
 * CTMHelper converts FOV transformation matrices to those
 * suitable for use by the PDFRenderer. The e and f elements
 * of the matrix will be divided by 1000 as FOV uses millipoints
 * as it's default user space and PDF uses points.
 *
 * @see com.wisii.fov.area.CTM
 *
...
public final class CTMHelper {
     ...
     * <p>For example:
     * <pre>
     *    com.wisii.fov.area.CTM ctm = 
     *          new com.wisii.fov.area.CTM(1.0, 0.0, 0.0, 1.0, 1000.0, 1000.0);
     *    String pdfMatrix =  com.wisii.fov.render.pdf.CTMHelper.toPDFString(ctm);
     * </pre>
     ...
     * <p>For example:
     * <pre>
     *    com.wisii.fov.area.CTM inCTM = 
     *          new com.wisii.fov.area.CTM(1.0, 0.0, 0.0, 1.0, 1000.0, 1000.0);
     *    com.wisii.fov.area.CTM outCTM = 
     *          com.wisii.fov.render.pdf.CTMHelper.toPDFCTM(ctm);
     * </pre>
