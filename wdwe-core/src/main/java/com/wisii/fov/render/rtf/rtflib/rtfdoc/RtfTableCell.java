...
/* $Id: RtfTableCell.java 426576 2006-07-28 15:44:37Z jeremias $ */
...
public class RtfTableCell
     ...
     * @throws IOException for I/O problems
     */
    // Modified by Boris Poud茅rous on 07/22/2002
    public RtfTable newTable(RtfAttributes attrs, ITableColumnsInfo tc) throws IOException {
        closeAll();
        table = new RtfTable(this, writer, attrs, tc); // Added tc Boris Poud茅rous 07/22/2002
        return table;
    }
    ...
    throws IOException {
        ...
        extraRowIndex = parentRow.getExtraRowSet().addTable((RtfTable)e,
                ...
                // Boris Poud茅rous added the passing of the current cell
