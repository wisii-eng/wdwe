 ...
 *//* $Id: Hyphenator.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
public class Hyphenator {
    ...
    public static HyphenationTree getHyphenationTree(String lang,
        ...
        if (hTree == null) {
            hTree = getFovHyphenationTree(key);
        }
     ...
     */
    public static HyphenationTree getFovHyphenationTree(String key) {
        HyphenationTree hTree = null;
        ...
        if (source != null) {
            try {
                ...
                if (in == null && source.getSystemId() != null) {
                    ...
                    throw new UnsupportedOperationException("提供的源对象不能装载hyphenation pattern file");
                }
