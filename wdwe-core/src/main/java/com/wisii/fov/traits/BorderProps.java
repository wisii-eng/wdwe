 ...
 *//* $Id: BorderProps.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */

package com.wisii.fov.traits;
...
public class BorderProps implements Serializable {
    ...
    private String getStyleString() {
        ...
        default: throw new IllegalStateException("无效的边框样式: " + style);
        }
    }
    ...
    private static int getConstantForStyle(String style) {
        if ("none".equalsIgnoreCase(style)) {
            ...
            throw new IllegalStateException("无效的边框样式: " + style);
        }
    }
    ...
    public static BorderProps valueOf(String s) {
        if (s.startsWith("(") && s.endsWith(")")) {
            ...
            throw new IllegalArgumentException("边框属性必须包含在圆括号中");
        }
    }
