 ...
 *//* $Id: InlineArea.java,v 1.2 2007/06/21 05:36:26 hzl Exp $ */
...
public class InlineArea extends Area {
    ...
    protected class InlineAdjustingInfo implements Serializable{
         ...
         */
        public InlineAdjustingInfo(int stretch, int shrink, int adj) {
   ...
   /* private Area parentArea = null;*/
     ...
     *
     * @see com.wisii.fov.area.Area#addChildArea(Area)
     */
    @Override
    ...
    /* 【添加：START】 by 李晓光 2009-8-18 */
    
    /* 【添加：END】 by 李晓光 2009-8-18 */
}
