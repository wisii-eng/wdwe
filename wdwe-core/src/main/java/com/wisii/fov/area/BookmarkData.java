 ...
 *//* $Id: BookmarkData.java,v 1.1 2007/04/12 06:41:18 cvsuser Exp $ */
...
import com.wisii.fov.fo.pagination.bookmarks.Bookmark;
...
public class BookmarkData extends AbstractOffDocumentItem implements Resolvable {
    ...
    /**
     * @see com.wisii.fov.area.Resolvable#getIDRefs()
     */
    ...
    /**
     * @see com.wisii.fov.area.OffDocumentItem#getName()
     */
