 ...
 *//* $Id: Trait.java,v 1.4 2007/04/24 02:58:05 zkl Exp $ */
...
public class Trait implements Serializable {
    ...
    public static final Integer IMAGE_LAYER = new Integer(37);
    //表示单元格是否为单元格
    public static final Integer TABLE_CELL = new Integer(38);
    ...
    public static class Background implements Serializable {
        ...
        private FovImage fovimage = null;
        ...
        /**
         * Returns the FovImage representing the background image
        ...
        /**
         * Sets the FovImage to use as the background image.
         * @param fovimage The FovImage to use
         */
        public void setFovImage(FovImage fovimage) {
        ...
        private String getRepeatString() {
            ...
            default: throw new IllegalStateException("非法重复风格: " + getRepeat());
            }
        }
        ...
        private static int getConstantForRepeat(String repeat) {
            if ("repeat".equalsIgnoreCase(repeat)) {
                ...
                throw new IllegalStateException("非法重复风格: " + repeat);
            }
        }
