 ...
 *//* $Id: AreaTreeParser.java,v 1.1 2007/04/12 06:41:18 cvsuser Exp $ */
...
import com.wisii.fov.area.inline.Character;
...
import com.wisii.fov.util.DefaultErrorListener;
    ...
    private static class Handler extends DefaultHandler {
        ...
        public void startElement(String uri, String localName, String qName, Attributes attributes)
            ...
            if (delegate != null) {
                ...
                try {
                    ...
                    throw new SAXException("创建 TransformerHandler时出错", e);
                }
                ...
                if (!handled) {
                    if (uri == null || uri.length() == 0) {
                        throw new SAXException(" 在命名空间 " + uri + "中," + "有未处理元素 " + localName );
                    } else {
        ...
        private class PageViewportMaker extends AbstractMaker {
            ...
            public void startElement(Attributes attributes) {
                ...
                if (currentPageViewport != null) {
                    throw new IllegalStateException("当前PageViewport必须为空");
                }
        ...
        private class TextMaker extends AbstractMaker {
            ...
            public void startElement(Attributes attributes) {
                if (getCurrentText() != null) {
                    throw new IllegalStateException("当前BodyRegion必须为空");
                }
        ...
        private class ForeignObjectMaker extends AbstractMaker {
            ...
            public void startElement(Attributes attributes) throws SAXException {
                ...
                if (domImplementation == null) {
                    throw new SAXException("没有DOMImplementation能够"
                            + " 用于处理命名空间: " + ns);
                }
        ...
        private void assertObjectOfClass(Object obj, Class clazz) {
            if (!clazz.isInstance(obj)) {
                throw new IllegalStateException("对象不是一个实例 "
                        + clazz.getName() + " 而是 " + obj.getClass().getName());
            }
        }
                ...
                if (value != null) {
                    ...
                    if (cl == Integer.class) {
                        ...
                        if (url != null) {
                            ...
                            FovImage img = fact.getImage(url, userAgent);
                            if (img == null) {
                                log.error("Background image not available: " + url);
                            } else {
                                // load dimensions
                                if (!img.load(FovImage.DIMENSIONS)) {
        ...
        private CTM getAttributeAsCTM(Attributes attributes, String name) {
            ...
            if (s.startsWith("[") && s.endsWith("]")) {
                ...
                throw new IllegalArgumentException("CTM 必须用方括号括起来");
            }
        }
