 ...
 *//* $Id: CachedRenderPagesModel.java,v 1.1 2007/04/12 06:41:18 cvsuser Exp $ */
...
public class CachedRenderPagesModel extends RenderPagesModel {
    ...
    public CachedRenderPagesModel (FOUserAgent userAgent, String outputFormat,
            FontInfo fontInfo, OutputStream stream) throws FOVException {
        super(userAgent, outputFormat, fontInfo, stream);
        this.baseDir = new File(System.getProperty("java.io.tmpdir"));
    }

    /**
     * @see com.wisii.fov.area.RenderPagesModel#checkPreparedPages(PageViewport, boolean)
     */
    ...
    protected void savePage(PageViewport page) {
        try {
            ...
            String fname = "fov-page-" + page.toString() + ".ser";
    ...
    /** @see com.wisii.fov.area.RenderPagesModel#endDocument() */
