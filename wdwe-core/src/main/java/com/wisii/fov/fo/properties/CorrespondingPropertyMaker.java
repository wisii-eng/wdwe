 ...
 *//* $Id: CorrespondingPropertyMaker.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
public class CorrespondingPropertyMaker {
     ...
     * are specified (in fovroperties.xml) to compute the value.
     * @throws FOVException for invalid or inconsistent FO input
     */
