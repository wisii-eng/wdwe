 ...
 */
/* $Id: FOPropertyMapping.java,v 1.11 2008/01/08 07:33:18 lzy Exp $ */
...
import com.wisii.fov.fo.flow.TableFObj.ColumnNumberPropertyMaker;
import com.wisii.fov.fo.properties.BackgroundPositionShorthandParser;
import com.wisii.fov.fo.properties.BorderSpacingShorthandParser;
import com.wisii.fov.fo.properties.BorderWidthPropertyMaker;
import com.wisii.fov.fo.properties.BoxPropShorthandParser;
import com.wisii.fov.fo.properties.CharacterProperty;
import com.wisii.fov.fo.properties.ColorProperty;
import com.wisii.fov.fo.properties.CondLengthProperty;
import com.wisii.fov.fo.properties.CorrespondingPropertyMaker;
import com.wisii.fov.fo.properties.DimensionPropertyMaker;
import com.wisii.fov.fo.properties.EnumProperty;
import com.wisii.fov.fo.properties.FontFamilyProperty;
import com.wisii.fov.fo.properties.FontShorthandParser;
import com.wisii.fov.fo.properties.FontShorthandProperty;
import com.wisii.fov.fo.properties.FontSizePropertyMaker;
import com.wisii.fov.fo.properties.FontStretchPropertyMaker;
import com.wisii.fov.fo.properties.GenericShorthandParser;
import com.wisii.fov.fo.properties.IndentPropertyMaker;
import com.wisii.fov.fo.properties.KeepProperty;
import com.wisii.fov.fo.properties.LengthPairProperty;
import com.wisii.fov.fo.properties.LengthProperty;
import com.wisii.fov.fo.properties.LengthRangeProperty;
import com.wisii.fov.fo.properties.LineHeightPropertyMaker;
import com.wisii.fov.fo.properties.ListProperty;
import com.wisii.fov.fo.properties.NumberProperty;
import com.wisii.fov.fo.properties.PageBreakShorthandParser;
import com.wisii.fov.fo.properties.PageDimensionMaker;
import com.wisii.fov.fo.properties.PositionShorthandParser;
import com.wisii.fov.fo.properties.Property;
import com.wisii.fov.fo.properties.PropertyMaker;
import com.wisii.fov.fo.properties.ReferenceOrientationMaker;
import com.wisii.fov.fo.properties.SpaceProperty;
import com.wisii.fov.fo.properties.SpacePropertyMaker;
import com.wisii.fov.fo.properties.SpacingPropertyMaker;
import com.wisii.fov.fo.properties.StringProperty;
import com.wisii.fov.fo.properties.TableBorderPrecedence;
import com.wisii.fov.fo.properties.TextDecorationProperty;
import com.wisii.fov.fo.properties.ToBeImplementedProperty;
import com.wisii.fov.fo.properties.VerticalAlignShorthandParser;
import com.wisii.fov.fo.properties.WhiteSpaceShorthandParser;
...
public final class FOPropertyMapping implements Constants {
    ...
    public void createGenerics() {
        ...
        sub  = new NumberProperty.Maker(PR_GRAPHIC_LAYER);
        sub.setInherited(false);
        sub.setDefault("0");
        addPropertyMaker("graphic-layer", sub);
        
        sub  = new NumberProperty.Maker(PR_BACKGROUNDGRAPHIC_LAYER);
        sub.setInherited(false);
        sub.setDefault("0");
        addPropertyMaker("background-image-layer", sub);
    ...
    public static PropertyMaker[] getGenericMappings() {
        ...
        gp.createEditorProperties();//add by zkl.
...
/*LF*/  addPropertyMaker("block-progression-unit", l);
    ...
    private void createPaginationAndLayoutProperties() {
        ...
        // media-usage  【删除】 by 李晓光 2008-03-02
...
//      addPropertyMaker("media-usage", m);
      ...
      // add by 李晓光 process Media-Usage
      m = new StringProperty.Maker(PR_MEDIA_USAGE);
      m.setInherited(false);
      m.setDefault("");
      addPropertyMaker("media-usage", m);
    ...
    private void createMiscProperties() {
        ...
        //src-type add by lzy.2008-01-08
        m = new StringProperty.Maker(this.PR_SRC_TYPE);
        m.setInherited(false);
        m.setDefault("");
        addPropertyMaker("src-type", m);

        //alpha add by lzy 2008-01-08
        m = new NumberProperty.Maker(this.PR_APHLA);
        m.setInherited(false);
        m.setDefault("0");
        addPropertyMaker("alpha", m);
    ...
    /**
     * add by zkl.
     * 添加节点的editmode, xpath, translateurl属性到PropertyList。
     * @see PropertyList.convertAttributeToProperty.
     */
    private void createEditorProperties(){
    	PropertyMaker m;
    	m=new NumberProperty.Maker(PR_EDITMODE);
    	m.setInherited(false);
    	m.setDefault("00");
    	addPropertyMaker("fov_editmode", m);

    	m=new StringProperty.Maker(PR_XPATH);
    	m.setInherited(false);
    	m.setDefault("/");
    	addPropertyMaker("fov_xpath", m);

    	m=new StringProperty.Maker(PR_TRANSLATEURL);
    	m.setInherited(false);
    	m.setDefault("");
    	addPropertyMaker("fov_translateurl", m);

    	m=new StringProperty.Maker(PR_HIDENAME);
    	m.setInherited(false);
    	m.setDefault("");
    	addPropertyMaker("fov_hidename", m);
    }
}
