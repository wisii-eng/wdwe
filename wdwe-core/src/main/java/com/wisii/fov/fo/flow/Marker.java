 ...
 *//* $Id: Marker.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
import com.wisii.fov.fo.PropertyListMaker;
...
public class Marker extends FObjMixed {
    ...
    protected class MarkerPropertyList extends PropertyList
         ...
         *
         * @see com.wisii.fov.fo.PropertyList#addAttributesToList(Attributes)
         */
         ...
         * @see com.wisii.fov.fo.PropertyList#putExplicit(int, Property)
         */
        ...
        /**
         * Null implementation; not used by this type of PropertyList
         * @see com.wisii.fov.fo.PropertyList#getExplicit(int)
         */
