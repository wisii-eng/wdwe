 ...
 *//* $Id: PropertyMaker.java,v 1.1 2007/04/12 06:41:19 cvsuser Exp $ */
...
import com.wisii.fov.fo.expr.PropertyInfo;
import com.wisii.fov.fo.expr.PropertyParser;
...
public class PropertyMaker implements Cloneable {
    ...
    public void addSubpropMaker(PropertyMaker subproperty) {
        throw new RuntimeException("不能增加属性标签 " + getClass());
    }
    ...
    public PropertyMaker getSubpropMaker(int subpropertyId) {
        throw new RuntimeException("不能增加属性标签");
    }
     ...
     */
     public Property make(PropertyList propertyList, String value,
        ...
        try {
            ...
            if (newProp == null) {
                throw new PropertyException("没有转化详细说明 " + pvalue);
            }
            return newProp;
