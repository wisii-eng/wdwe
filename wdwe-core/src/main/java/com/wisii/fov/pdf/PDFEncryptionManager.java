...
/* $Id: PDFEncryptionManager.java 426576 2006-07-28 15:44:37Z jeremias $ */
 ...
 * feature to be optional to FOV depending on the availability of JCE.
 */
public class PDFEncryptionManager {
    ...
    public static PDFEncryption newInstance(int objnum, PDFEncryptionParams params) {
        try {
            Class clazz = Class.forName("com.wisii.fov.pdf.PDFEncryptionJCE");
