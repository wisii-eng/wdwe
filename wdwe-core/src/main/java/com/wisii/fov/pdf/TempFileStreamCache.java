...
/* $Id: TempFileStreamCache.java 426576 2006-07-28 15:44:37Z jeremias $ */
...
public class TempFileStreamCache implements StreamCache {
    ...
    public TempFileStreamCache() throws IOException {
        tempFile = File.createTempFile("com.wisii.fov.pdf.StreamCache-",
                                       ".temp");
    ...
    /**
     * @see com.wisii.fov.pdf.StreamCache#write(byte[])
     */
