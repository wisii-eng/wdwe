...
/* $Id: PDFFactory.java 426576 2006-07-28 15:44:37Z jeremias $ */
...
import com.wisii.fov.fonts.CustomFont;
import com.wisii.fov.fonts.Typeface;
import com.wisii.fov.fonts.FontDescriptor;
import com.wisii.fov.fonts.FontMetrics;
import com.wisii.fov.fonts.FontType;
import com.wisii.fov.fonts.LazyFont;
import com.wisii.fov.fonts.MultiByteFont;
import com.wisii.fov.fonts.truetype.FontFileReader;
import com.wisii.fov.fonts.truetype.TTFSubSetFile;
import com.wisii.fov.fonts.type1.PFBData;
import com.wisii.fov.fonts.type1.PFBParser;
...
public class PDFFactory {
     ...
     * use it in FOV. It is added for completeness sake.
     ...
     * @see PDFXObject
     * @see com.wisii.fov.image.JpegImage
     * @see com.wisii.fov.pdf.PDFDeviceColorSpace
