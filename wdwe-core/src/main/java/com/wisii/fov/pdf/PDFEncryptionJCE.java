...
/* $Id: PDFEncryptionJCE.java 426576 2006-07-28 15:44:37Z jeremias $ */
...
public class PDFEncryptionJCE extends PDFObject implements PDFEncryption {
    ...
    private class EncryptionFilter extends PDFFilter {
        ...
        /**
         * @see com.wisii.fov.pdf.PDFFilter#encode(InputStream, OutputStream, int)
         */
    ...
    /**
     * @see com.wisii.fov.pdf.PDFEncryption#encrypt(byte[], PDFObject)
     */
    ...
    /**
     * @see com.wisii.fov.pdf.PDFEncryption#getTrailerEntry()
     */
