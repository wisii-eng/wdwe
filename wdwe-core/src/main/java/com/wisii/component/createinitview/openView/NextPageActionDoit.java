...
public class NextPageActionDoit extends Command
 {

	public NextPageActionDoit(String name, String iconName) {
		super(name, iconName);
	}

	public void action(ActionEvent e) {
		EnginePanel enginepanel=EngineUtil.getEnginepanel();
        int olapage = enginepanel.getPreviewPanel().getPage()+1;
        enginepanel.goToPage(olapage+1);
	}
