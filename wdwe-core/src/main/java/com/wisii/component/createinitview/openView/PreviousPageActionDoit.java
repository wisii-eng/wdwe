...
public class PreviousPageActionDoit extends Command {

	public PreviousPageActionDoit(String name, String iconName) {
		super(name, iconName);
	}

	public void action(ActionEvent e) {
		EnginePanel enginepanel = EngineUtil.getEnginepanel();
		enginepanel.goToPage(enginepanel.getPreviewPanel().getPage());
	}
	public boolean isEnabled()
	{
		...
		EnginePanel enginepanel=EngineUtil.getEnginepanel();
		return enginepanel.getPreviewPanel().getPage()>0;
	}
}
